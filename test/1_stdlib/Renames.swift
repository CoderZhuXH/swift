...
typealias CPQL = CustomPlaygroundQuickLookable // expected-error {{'CustomPlaygroundQuickLookable' is unavailable: it has been moved to the 'PlaygroundSupport' module. Please 'import PlaygroundSupport'}}
typealias PQL = PlaygroundQuickLook // expected-error {{'PlaygroundQuickLook' is unavailable: it has been moved to the 'PlaygroundSupport' module. Please 'import PlaygroundSupport'}}
